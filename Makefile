...
LDFLAGS = -X "github.com/starskim/DDBOT/lsp.BuildTime='"$(BUILD_TIME)"'" -X "github.com/starskim/DDBOT/lsp.CommitId='"$(COMMIT_ID)"'"
...
$(TARGET): $(SRC) go.mod go.sum
	go build -ldflags '$(LDFLAGS)' -o $(TARGET) github.com/starskim/DDBOT/cmd
